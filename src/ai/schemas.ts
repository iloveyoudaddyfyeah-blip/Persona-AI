...
export const GeneratePersonalityProfileInputSchema = z.object({
  ...
  tone: z.string().optional().default('default').describe("The tone of voice for the generation. Can be one of: 'default', 'joyful', 'anxious', 'angry', 'serene', 'passionate', 'apathetic', 'fearful', 'hopeful', 'jaded', 'enthusiastic', 'grumpy', 'curious', 'confident', 'shy', 'ambitious', 'content', 'bitter', 'loving', 'resentful', 'brave', 'timid', 'arrogant', 'humble', 'playful', 'reserved', 'melancholy', 'whimsical', 'sarcastic', 'cynical', 'optimistic', 'pessimistic', 'nervous', 'calm', 'irritable', 'cheerful', 'dramatic', 'stoic', 'flirtatious', 'formal', 'informal', 'witty', 'pompous', 'insecure', 'nurturing', 'distant', 'methodical', 'chaotic', 'mysterious', 'direct', 'dreamy', 'stern', 'goofy', 'brooding', 'paranoid', 'apprehensive', 'worried', 'panicked', 'terrified', 'vulnerable', 'helpless', 'overwhelmed', 'heroic', 'valiant', 'daring', 'fearless', 'courageous', 'bold', 'gallant', 'indomitable', 'resolute', 'steadfast', 'furious', 'enraged', 'livid', 'irate', 'hostile', 'aggressive', 'vengeful', 'spiteful', 'contemptuous', 'scornful', 'ecstatic', 'elated', 'jubilant', 'gleeful', 'euphoric', 'radiant', 'lighthearted', 'effervescent', 'exuberant', 'seraphic', 'tranquil', 'placid', 'peaceful', 'composed', 'halcyon', 'unruffled', 'sedate', 'restful', 'despondent', 'somber', 'morose', 'gloomy', 'grief-stricken', 'heartbroken', 'forlorn', 'disconsolate', 'crestfallen', 'alienated', 'detached', 'uninterested', 'listless', 'indifferent', 'dispassionate', 'neutral', 'aloof', 'haughty', 'conceited', 'smug', 'pretentious', 'imperious', 'domineering', 'boastful', 'self-righteous', 'meek', 'modest', 'unassuming', 'retiring', 'demure', 'unpretentious', 'self-effacing'"),
